...
# -*- encoding: utf-8 -*-
# stub: battleweb-wow 0.0.0 ruby lib

Gem::Specification.new do |s|
  s.name = "battleweb-wow".freeze
  s.version = "0.0.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Duane Conn".freeze]
  s.date = "2016-04-28"
  s.description = "TODO: longer description of your gem".freeze
  s.email = "duane.conn@gmail.com".freeze
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.rdoc"
  ]
  s.files = [
    ...
    "Rakefile",
    "VERSION",
    "lib/battleweb-wow.rb",
    "spec/battleweb-wow_spec.rb",
    "spec/spec_helper.rb"
  ]
  s.homepage = "http://github.com/duaconn/battleweb-wow".freeze
